  ...
  return (
    <StudentLayout>
      <div className="max-w-7xl mx-auto px-4 py-8 text-white">
        <h1 className="text-4xl font-bold mb-8 text-[#65a0ff] flex items-center gap-2 border-b border-[#65a0ff] pb-2">
          <MdInsights className="text-[#65a0ff] text-3xl" /> My Progress
        </h1>


        {/* Charts Section */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
          <div className="bg-[#0f1c3f] rounded-2xl p-6 shadow-xl border border-indigo-600">
            <h2 className="flex items-center gap-2 text-2xl font-semibold mb-4">
                <MdBarChart className="text-indigo-400 text-2xl" /> Course Completion
            </h2>
          ...
          <div className="bg-[#0f1c3f] rounded-2xl p-6 shadow-xl border border-indigo-600">
            <h2 className="flex items-center gap-2 text-2xl font-semibold mb-4">
                <BsBook className="text-indigo-400 text-2xl" /> Course Progress Overview
            </h2>
            <div className="h-[280px]">
        ...
        <div className="bg-[#0f1c3f] rounded-2xl p-6 shadow-xl border border-indigo-600">
          <h2 className="flex items-center gap-2 text-2xl font-semibold mb-6">
            <HiOutlineDocumentReport className="text-indigo-400 text-2xl" /> Enrolled Courses
        </h2>

          {enrollments.length === 0 ? (
            <p className="text-gray-300">You are not enrolled in any courses yet.</p>
          ) : (
            <ul className="space-y-6 max-h-[400px] overflow-y-auto pr-2 scrollbar-thin scrollbar-thumb-indigo-500 scrollbar-track-gray-800">
              {enrollments.map((enrollment) => {
                ...
                return (
                  <li
                    key={enrollment._id}
                    className="border border-gray-700 rounded-xl p-5 bg-[#152856] shadow-sm"
                  >
                    ...
                    <div className="flex justify-between items-center text-sm text-gray-200">
                      ...
                      {progressPercent === 100 && (
                        <span className="flex items-center gap-1 text-green-400 font-medium">
                          <BsPatchCheckFill className="text-lg" /> Completed
                        </span>
                      )}
                    </div>
                  </li>
