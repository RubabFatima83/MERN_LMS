            ...
            >
              ...
              >
                ...
                <div className="flex flex-col">
                  <div className="text-sm text-white font-semibold flex gap-2 items-center">
              ...
              {/* Comment Content */}
              <p
                className="text-base text-gray-200 leading-relaxed mt-3 cursor-pointer"
                onClick={() => toggleExpand(comment._id)}
              >
                {comment.content}
              </p>
              ...
              {isExpanded && (
                <div className="mt-4 space-y-4">
                  {(comment.replies || []).map((reply) => {
                    const isMentor = ['Instructor', 'Mentor'].includes(reply.userId?.role);
                    return (
                      <div
                      ...
                      >
                        <div className="flex items-center gap-2 text-sm text-gray-300 mb-1">
                          ...
                          {isMentor && <BsPatchCheckFill className="text-indigo-400" />}
                  ...
                  {/* Reply Input */}
                  <div className="flex flex-col gap-2 items-center md:flex-row space-x-2 ml-4">
                    <input
                      type="text"
